 ...
 * @author NEK PC
 */
public class StudentViewAttendanceUI extends javax.swing.JFrame {

    /**
     * Creates new form AdminUI
     */
    public StudentViewAttendanceUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        attendance_btn.setBackground(new java.awt.Color(0, 102, 255));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentViewAttendanceUI().setVisible(true);
            }
        });
    }
