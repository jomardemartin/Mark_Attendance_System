...
public class AdminEditTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        back_teacher_mngmnt = new javax.swing.JLabel();
        ...
        teachermanagement_lbl.setText("Edit Teacher");
        ...
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 230, 90, 30));
        jPanel2.add(txt_address, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 200, 30));

        jLabel16.setFont(new java.awt.Font("Nirmala UI", 1, 15)); // NOI18N
        jLabel16.setText("Address:");
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 90, 30));

        gender_box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Male", "Female" }));
        jPanel2.add(gender_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 260, 120, 30));

        jLabel17.setFont(new java.awt.Font("Nirmala UI", 1, 15)); // NOI18N
        jLabel17.setText("Last Name:");
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 90, 30));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel19.setText("Teacher Information");
        ...
        jPanel2.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 60, 30));
        jPanel2.add(txt_fname, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 200, 30));
        jPanel2.add(txt_lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 200, 30));
        ...
        jPanel2.add(department, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 200, 30));

        jLabel22.setFont(new java.awt.Font("Nirmala UI", 1, 15)); // NOI18N
        jLabel22.setText("Department:");
        jPanel2.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 100, 30));

        jLabel13.setFont(new java.awt.Font("Nirmala UI", 1, 15)); // NOI18N
        jLabel13.setText("Subject:");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 320, 90, 30));

        jLabel24.setFont(new java.awt.Font("Nirmala UI", 1, 15)); // NOI18N
        jLabel24.setText("First Name:");
        jPanel2.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 90, 30));
        jPanel2.add(txt_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 60, 30));
        ...
        jPanel2.add(subject, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 350, 200, 30));

        bg.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 140, 860, 560));

        back_teacher_mngmnt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Login_Pic/back-icon.png"))); // NOI18N
        back_teacher_mngmnt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                back_teacher_mngmntMouseClicked(evt);
            }
        });
        bg.add(back_teacher_mngmnt, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 20, -1, -1));
    ...
    private void edit_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edit_btnMouseClicked
        ...
        //ResultSet rs;
        String query = "UPDATE teacher_info SET teacher_fname=?, teacher_lname=?, teacher_address=?, teacher_gender=?, subject=?, department=? WHERE user_idfk=?";
        String fname = txt_fname.getText();
        String lname = txt_lname.getText();
        String address = txt_address.getText();
        String gender = gender_box.getSelectedItem().toString();
        String subjects = subject.getSelectedItem().toString();
    ...
    private void back_teacher_mngmntMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_back_teacher_mngmntMouseClicked
        AdminTeacherManagementUI back_teacher_mngmt = new AdminTeacherManagementUI();
        back_teacher_mngmt.setVisible(true);
        back_teacher_mngmt.pack();
        back_teacher_mngmt.setLocationRelativeTo(null);
        back_teacher_mngmt.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    }//GEN-LAST:event_back_teacher_mngmntMouseClicked
    ...
    private javax.swing.JLabel back_teacher_mngmnt;
